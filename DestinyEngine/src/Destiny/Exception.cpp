...
char const* Destiny::Exception::what() const
{
...
const char* Destiny::Exception::getType() const
{
	return "Destiny Exception";
}

uint16_t Destiny::Exception::getLine() const
{
	return m_Line;
}

const std::string& Destiny::Exception::getFile() const
{
	return m_File;
}

const std::string& Destiny::Exception::getMsg() const
{
	return m_Msg;
}
