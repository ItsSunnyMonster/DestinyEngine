...
Destiny::D3D11Exception::D3D11Exception(uint16_t line, const char* file, HRESULT hr, std::vector<std::string> infoMsgs /*= {}*/)
...
const char* Destiny::D3D11Exception::what() const
{
...
Destiny::D3D11DeviceRemovedException::D3D11DeviceRemovedException(uint16_t line, const char* file, HRESULT reason)
	: D3D11Exception(line, file, reason)
{
}

char const* Destiny::D3D11DeviceRemovedException::what() const
{
	std::ostringstream oss;
	oss << getType() << std::endl
...
Destiny::D3D11InfoOnlyException::D3D11InfoOnlyException(uint16_t line, const char* file, std::vector<std::string> infoMsgs /*= {}*/)
	: Exception(line, file)
{
	for (const std::string& msg : infoMsgs)
	{
...
const char* Destiny::D3D11InfoOnlyException::what() const
{
	std::ostringstream oss;
	oss << getType() << std::endl
		<< "[Info Log] " << getErrorInfo() << std::endl
