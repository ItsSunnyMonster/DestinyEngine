...
std::unordered_map<Destiny::Win32KeyCode, Destiny::KeyCode> Destiny::WindowsInput::s_KeyMapWin32ToDT;
std::unordered_map<Destiny::KeyCode, Destiny::Win32KeyCode> Destiny::WindowsInput::s_KeyMapDTToWin32;
std::unordered_map<Destiny::Win32MouseCode, Destiny::MouseCode> Destiny::WindowsInput::s_MouseMapWin32ToDT;
std::unordered_map<Destiny::MouseCode, Destiny::Win32MouseCode> Destiny::WindowsInput::s_MouseMapDTToWin32;
...
{
	if (GetForegroundWindow() != Application::get()->getWindow()->getNativeWindow())
	{
		return false;
	}
...
std::pair<float, float> Destiny::WindowsInput::_getMousePosition()
{
	...
	ScreenToClient((HWND)Application::get()->getWindow()->getNativeWindow(), &mousePos);
