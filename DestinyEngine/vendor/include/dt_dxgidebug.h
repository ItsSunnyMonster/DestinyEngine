/*
 * This file is copied from the Windows SDK.
 * Since the one in MinGW does not define IDXGIInfoQueue.
 */
...
DEFINE_GUID(DXGI_DEBUG_ALL, 0xe48ae283, 0xda80, 0x490b, 0x87, 0xe6, 0x43, 0xe9,
            0xa9, 0xcf, 0xda, 0x8);
DEFINE_GUID(DXGI_DEBUG_DX, 0x35cdd7fc, 0x13b2, 0x421d, 0xa5, 0xd7, 0x7e, 0x44,
            0x51, 0x28, 0x7d, 0x64);
DEFINE_GUID(DXGI_DEBUG_DXGI, 0x25cddaa4, 0xb1c6, 0x47e1, 0xac, 0x3e, 0x98, 0x87,
            0x5b, 0x5a, 0x2e, 0x2a);
DEFINE_GUID(DXGI_DEBUG_APP, 0x6cd6e01, 0x4219, 0x4ebd, 0x87, 0x9, 0x27, 0xed,
            0x23, 0x36, 0xc, 0x62);
typedef enum DXGI_INFO_QUEUE_MESSAGE_CATEGORY {
  ...
  DXGI_INFO_QUEUE_MESSAGE_CATEGORY_MISCELLANEOUS =
      (DXGI_INFO_QUEUE_MESSAGE_CATEGORY_UNKNOWN + 1),
  ...
  DXGI_INFO_QUEUE_MESSAGE_CATEGORY_COMPILATION =
      (DXGI_INFO_QUEUE_MESSAGE_CATEGORY_CLEANUP + 1),
  ...
  DXGI_INFO_QUEUE_MESSAGE_CATEGORY_SHADER =
      (DXGI_INFO_QUEUE_MESSAGE_CATEGORY_EXECUTION + 1)
...
typedef enum DXGI_INFO_QUEUE_MESSAGE_SEVERITY {
  ...
  DXGI_INFO_QUEUE_MESSAGE_SEVERITY_ERROR =
      (DXGI_INFO_QUEUE_MESSAGE_SEVERITY_CORRUPTION + 1),
  DXGI_INFO_QUEUE_MESSAGE_SEVERITY_WARNING =
      (DXGI_INFO_QUEUE_MESSAGE_SEVERITY_ERROR + 1),
  DXGI_INFO_QUEUE_MESSAGE_SEVERITY_INFO =
      (DXGI_INFO_QUEUE_MESSAGE_SEVERITY_WARNING + 1),
  DXGI_INFO_QUEUE_MESSAGE_SEVERITY_MESSAGE =
      (DXGI_INFO_QUEUE_MESSAGE_SEVERITY_INFO + 1)
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetMessage(
      ...
      /* [annotation] */
      _Out_writes_bytes_opt_(*pMessageByteLength) DXGI_INFO_QUEUE_MESSAGE *
          pMessage,
      /* [annotation] */
  ...
  virtual HRESULT STDMETHODCALLTYPE GetStorageFilter(
      ...
      _In_ DXGI_DEBUG_ID Producer,
      /* [annotation] */
      _Out_writes_bytes_opt_(*pFilterByteLength) DXGI_INFO_QUEUE_FILTER *
          pFilter,
      /* [annotation] */
...
#define IDXGIInfoQueue_GetMessage(This, Producer, MessageIndex, pMessage,      \
                                  pMessageByteLength)                          \
  ((This)->lpVtbl->GetMessage(This, Producer, MessageIndex, pMessage,          \
                              pMessageByteLength))

#define IDXGIInfoQueue_GetNumStoredMessagesAllowedByRetrievalFilters(This,     \
                                                                     Producer) \
  ((This)->lpVtbl->GetNumStoredMessagesAllowedByRetrievalFilters(This,         \
                                                                 Producer))

#define IDXGIInfoQueue_GetNumStoredMessages(This, Producer)                    \
  ((This)->lpVtbl->GetNumStoredMessages(This, Producer))

#define IDXGIInfoQueue_GetNumMessagesDiscardedByMessageCountLimit(This,        \
                                                                  Producer)    \
...
#define IDXGIInfoQueue_GetStorageFilter(This, Producer, pFilter,               \
                                        pFilterByteLength)                     \
...
#define IDXGIInfoQueue_GetRetrievalFilter(This, Producer, pFilter,             \
                                          pFilterByteLength)                   \
  ((This)->lpVtbl->GetRetrievalFilter(This, Producer, pFilter,                 \
                                      pFilterByteLength))
...
#define IDXGIInfoQueue_AddMessage(This, Producer, Category, Severity, ID,      \
                                  pDescription)                                \
  ((This)->lpVtbl->AddMessage(This, Producer, Category, Severity, ID,          \
                              pDescription))
...
public:
  virtual HRESULT STDMETHODCALLTYPE ReportLiveObjects(
      GUID apiid, DXGI_DEBUG_RLO_FLAGS flags) = 0;
};
...
typedef struct IDXGIDebugVtbl {
  ...
  (IDXGIDebug *This, GUID apiid, DXGI_DEBUG_RLO_FLAGS flags);
...
typedef struct IDXGIDebug1Vtbl {
  ...
  ULONG(STDMETHODCALLTYPE *Release)(IDXGIDebug1 *This);

  HRESULT(STDMETHODCALLTYPE *ReportLiveObjects)
  (IDXGIDebug1 *This, GUID apiid, DXGI_DEBUG_RLO_FLAGS flags);

  void(STDMETHODCALLTYPE *EnableLeakTrackingForThread)(IDXGIDebug1 *This);

  void(STDMETHODCALLTYPE *DisableLeakTrackingForThread)(IDXGIDebug1 *This);
...
#pragma endregion
DEFINE_GUID(IID_IDXGIInfoQueue, 0xD67441C7, 0x672A, 0x476f, 0x9E, 0x82, 0xCD,
            0x55, 0xB4, 0x49, 0x49, 0xCE);
DEFINE_GUID(IID_IDXGIDebug, 0x119E7452, 0xDE9E, 0x40fe, 0x88, 0x06, 0x88, 0xF9,
            0x0C, 0x12, 0xB4, 0x41);
DEFINE_GUID(IID_IDXGIDebug1, 0xc5a05f0c, 0x16f2, 0x4adf, 0x9f, 0x4d, 0xa8, 0xc4,
            0xd5, 0x8a, 0xc5, 0x50);
